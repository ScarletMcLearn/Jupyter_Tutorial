...
# 
# * An example of [html without execution](./output_format/Jupyter+Notebook+Presentation.html) and [html with execution](./out_put_format/Jupyter+Notebook+Presentation+With+Execution.html)
# 
# * An example of [pdf](./output_format/Jupyter+Notebook+Presentation.pdf)
# * An example of [py]()
